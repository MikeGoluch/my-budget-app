...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.deleteStorageItem = exports.retrieveData = exports.storeData = exports.calculateItemPercentage = exports.newItem = exports.getItemPercentage = exports.getBudgetInfo = exports.deleteCtrlItem = exports.calculateBudget = exports.globalData = exports.calculateTotalAmounts = undefined;\n\nvar _Expense = __webpack_require__(/*! ../models/Expense.js */ \"./src/js/models/Expense.js\");\n\nvar _Income = __webpack_require__(/*! ../models/Income.js */ \"./src/js/models/Income.js\");\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\n//BUDGET CONTROLLER\n\nvar calculateTotalAmounts = exports.calculateTotalAmounts = function calculateTotalAmounts(type) {\n    var total = 0;\n    globalData.allData[type].forEach(function (cur) {\n        total += cur.value;\n    });\n    globalData.totalAmount[type] = total;\n};\n\nvar globalData = exports.globalData = {\n    allData: {\n        inc: [],\n        exp: []\n    },\n    totalAmount: {\n        inc: [],\n        exp: []\n    },\n    totalBudget: 0,\n    totalPercentages: 0\n};\n\nvar calculateBudget = exports.calculateBudget = function calculateBudget() {\n    calculateTotalAmounts('inc');\n    calculateTotalAmounts('exp');\n    globalData.totalBudget = globalData.totalAmount.inc - globalData.totalAmount.exp;\n    if (globalData.totalAmount.inc > 0) {\n        globalData.totalPercentages = Math.round(globalData.totalAmount.exp / globalData.totalAmount.inc * 100);\n    } else {\n        globalData.totalPercentages = -1;\n    }\n};\n\nvar deleteCtrlItem = exports.deleteCtrlItem = function deleteCtrlItem(itemType, itemId) {\n    var ids = globalData.allData[itemType].map(function (cur) {\n        return cur.id;\n    });\n    var indexNumber = ids.indexOf(itemId);\n    console.log(indexNumber);\n    if (indexNumber !== -1) {\n        globalData.allData[itemType].splice(indexNumber, 1);\n    };\n    return {\n        itemType: itemType,\n        itemId: itemId\n    };\n};\n\nvar getBudgetInfo = exports.getBudgetInfo = function getBudgetInfo() {\n    return {\n        totalBudget: globalData.totalBudget,\n        totalIncome: globalData.totalAmount.inc,\n        totalExpense: globalData.totalAmount.exp,\n        totalPercentages: globalData.totalPercentages,\n        totalData: globalData.allData\n    };\n};\n\nvar getItemPercentage = exports.getItemPercentage = function getItemPercentage() {\n    var allPercentages = globalData.allData.exp.map(function (cur) {\n        return cur.getPercentage();\n    });\n    return allPercentages;\n};\n\nvar newItem = exports.newItem = function newItem(type, description, value) {\n    var newItem = void 0;\n    var id = void 0;\n    if (globalData.allData[type].length > 0) {\n        id = globalData.allData[type][globalData.allData[type].length - 1].id + 1;\n    } else {\n        id = 0;\n    }\n    if (type === 'inc') {\n        newItem = new _Income.Income(id, description, value, type);\n        newItem.incomeDateStamp();\n    } else if (type === 'exp') {\n        newItem = new _Expense.Expense(id, description, value, type);\n        newItem.expenseDateStamp();\n    }\n    globalData.allData[type].push(newItem);\n    return newItem;\n};\n\nvar calculateItemPercentage = exports.calculateItemPercentage = function calculateItemPercentage() {\n    console.log('gd', globalData.totalAmount.inc);\n    console.log('test', globalData.allData.exp);\n    if (globalData.allData.exp) {\n        globalData.allData.exp.forEach(function (cur) {\n            cur.calculatePercentage(globalData.totalAmount.inc);\n        });\n    }\n};\n\nvar storeData = exports.storeData = function storeData() {\n    var allItems = [].concat(_toConsumableArray(globalData.allData.inc), _toConsumableArray(globalData.allData.exp));\n    console.log('ai', allItems);\n    if (localStorage) {\n        localStorage.setItem('items', JSON.stringify(allItems));\n    };\n};\n\nvar retrieveData = exports.retrieveData = function retrieveData() {\n    var storage = JSON.parse(localStorage.getItem('items'));\n    console.log('storage2', storage);\n    storage.forEach(function (cur) {\n        if (cur.type === 'exp') {\n            Object.setPrototypeOf(cur, _Expense.Expense.prototype);\n        } else if (cur.type === 'inc') {\n            Object.setPrototypeOf(cur, _Income.Income.prototype);\n        };\n    });\n    console.log('storage1', storage);\n    storage.forEach(function (el) {\n        if (el.type === 'inc') {\n            globalData.allData.inc.push(el);\n        } else {\n            globalData.allData.exp.push(el);\n        }\n    });\n    console.log('storage', storage);\n    return storage;\n};\n\nvar deleteStorageItem = exports.deleteStorageItem = function deleteStorageItem(id, type) {\n    // console.log(selectedItemId)\n    console.log('delid', id);\n    console.log('deltype', type);\n    var retrieveData = JSON.parse(localStorage.getItem('items'));\n    console.log('rd', retrieveData);\n    // for (let specificItem of retrieveData) {\n    //     if (specificItem.id === id && specificItem.type === type) {\n    //         retrieveData.splice(specificItem.id, 1);\n    //         localStorage.setItem('items', JSON.stringify(retrieveData));\n    //     }\n    // }\n    retrieveData.forEach(function (cur, index) {\n        if (cur.id === id && cur.type === type) {\n            retrieveData.splice(index, 1);\n            localStorage.setItem('items', JSON.stringify(retrieveData));\n        }\n    });\n};\n\n//# sourceURL=webpack:///./src/js/components/budgetctrl.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n//UI CONTROLLER\n\nvar domPaths = exports.domPaths = {\n    addBtn: '.add__btn',\n    clearStorageBtn: '.clear__btn',\n    descriptionInput: '.add__description',\n    valueInput: '.add__value',\n    typeInput: '.add__type',\n    incomeList: '.income__list',\n    expenseList: '.expenses__list',\n    totalBudgetDisplay: '.budget__value',\n    totalIncomeDisplay: '.budget__income--value',\n    totalExpenseDisplay: '.budget__expenses--value',\n    totalExpensePercentageDisplay: '.budget__expenses--percentage',\n    itemsContainer: '.container',\n    itemPercentage: '.item__percentage',\n    monthDesc: '.budget__title--month'\n};\n\nvar clearInputValues = exports.clearInputValues = function clearInputValues() {\n    document.querySelector(domPaths.descriptionInput).value = '';\n    document.querySelector(domPaths.valueInput).value = '';\n};\n\nvar changeBorderColor = exports.changeBorderColor = function changeBorderColor() {\n    var inputType = document.querySelector(domPaths.typeInput);\n    var children = document.querySelectorAll('[data-border=\\'toggle\\']');\n    var childrenArray = Array.from(children);\n    inputType.addEventListener('change', function () {\n        inputType.classList.toggle('toggle_border');\n        document.querySelector(domPaths.descriptionInput).focus();\n        childrenArray.forEach(function (cur) {\n            cur.classList.toggle('toggle_border_container');\n        });\n    });\n};\n\nvar displayItem = exports.displayItem = function displayItem(item) {\n    var incList = document.querySelector(domPaths.incomeList);\n    var expList = document.querySelector(domPaths.expenseList);\n    var incMarkup = '<div class=\"item clearfix\" id=\"' + item.type + '-' + item.id + '\">\\n        <div class=\"item_date\">' + item.date + '</div>\\n        <div class=\"item__description\">' + item.description + '</div>\\n        <div class=\"right clearfix\">\\n            <div class=\"item__value\">' + displayFormatedNumber(item.value, item.type) + '</div>\\n            <div class=\"item__delete\">\\n                <button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button>\\n            </div>\\n        </div>\\n    </div>';\n    var expMarkup = '<div class=\"item clearfix\" id=\"' + item.type + '-' + item.id + '\">\\n        <div class=\"item_date\">' + item.date + '</div>\\n        <div class=\"item__description\">' + item.description + '</div>\\n        <div class=\"right clearfix\">\\n            <div class=\"item__value\">' + displayFormatedNumber(item.value, item.type) + '</div>\\n            <div class=\"item__percentage\">' + item.percentage + '%</div>\\n            <div class=\"item__delete\">\\n                <button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button>\\n            </div>\\n        </div>\\n    </div>';\n    item.type === 'inc' ? incList.insertAdjacentHTML('beforeend', incMarkup) : expList.insertAdjacentHTML('beforeend', expMarkup);\n};\n\nvar displayFormatedNumber = exports.displayFormatedNumber = function displayFormatedNumber(number, type) {\n    var formatOptions = { style: 'currency', currency: 'USD' };\n    var formatedNumber = new Intl.NumberFormat('en-US', formatOptions);\n    return type === 'inc' ? '+' + formatedNumber.format(number) : '-' + formatedNumber.format(number);\n};\n\nvar displayItemPercentage = exports.displayItemPercentage = function displayItemPercentage(percentageArr) {\n    var itemPercentageFields = document.querySelectorAll(domPaths.itemPercentage);\n    var nodeListToArr = Array.from(itemPercentageFields);\n    nodeListToArr.forEach(function (cur, index) {\n        if (percentageArr[index] > 0) {\n            cur.textContent = percentageArr[index] + '%';\n        } else {\n            cur.textContent = '---';\n        }\n    });\n};\n\nvar displayBudgetInfo = exports.displayBudgetInfo = function displayBudgetInfo(obj) {\n    var type = void 0;\n    obj.totalBudget > 0 ? type = 'inc' : 'exp';\n    document.querySelector(domPaths.totalBudgetDisplay).innerHTML = displayFormatedNumber(obj.totalBudget, type);\n    document.querySelector(domPaths.totalIncomeDisplay).innerHTML = displayFormatedNumber(obj.totalIncome, 'inc');\n    document.querySelector(domPaths.totalExpenseDisplay).innerHTML = displayFormatedNumber(obj.totalExpense, 'exp');\n    if (obj.totalPercentages > 0) {\n        document.querySelector(domPaths.totalExpensePercentageDisplay).innerHTML = obj.totalPercentages + '%';\n    } else {\n        document.querySelector(domPaths.totalExpensePercentageDisplay).innerHTML = '---';\n    }\n};\n\nvar deleteUiItem = exports.deleteUiItem = function deleteUiItem(itemId) {\n    var el = document.getElementById(itemId);\n    el.parentNode.removeChild(el);\n};\n\nvar displayMonth = exports.displayMonth = function displayMonth() {\n    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];\n    var dateObj = new Date();\n    var date = months[dateObj.getMonth()] + ' ' + dateObj.getFullYear();\n    document.querySelector(domPaths.monthDesc).textContent = date;\n};\n\nvar deleteAllIncomeItems = exports.deleteAllIncomeItems = function deleteAllIncomeItems() {\n    var parentEl = document.querySelector(domPaths.incomeList);\n    while (parentEl.firstChild) {\n        parentEl.removeChild(parentEl.lastChild);\n    }\n};\n\nvar deleteAllExpenseItems = exports.deleteAllExpenseItems = function deleteAllExpenseItems() {\n    var parentEl = document.querySelector(domPaths.expenseList);\n    while (parentEl.firstChild) {\n        parentEl.removeChild(parentEl.lastChild);\n    }\n};\n\nvar deleteAllUiItems = exports.deleteAllUiItems = function deleteAllUiItems() {\n    deleteAllIncomeItems();\n    deleteAllExpenseItems();\n};\n\nvar getDomPaths = exports.getDomPaths = function getDomPaths() {\n    return domPaths;\n};\n\nvar getInputs = exports.getInputs = function getInputs() {\n    var typeInput = document.querySelector(domPaths.typeInput).value;\n    var descInput = document.querySelector(domPaths.descriptionInput).value;\n    var valueInput = parseFloat(document.querySelector(domPaths.valueInput).value);\n    return {\n        type: typeInput,\n        description: descInput,\n        value: valueInput\n    };\n};\n\n//# sourceURL=webpack:///./src/js/views/uictrl.js?");
