...
/***/ "./src/js/components/budgetctrl.js":
/*!*****************************************!*\
  !*** ./src/js/components/budgetctrl.js ***!
  \*****************************************/
/*! exports provided: calculateTotalAmounts, globalData, calculateBudget, deleteCtrlItem, getBudgetInfo, getItemPercentage, newItem, calculateItemPercentage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"calculateTotalAmounts\", function() { return calculateTotalAmounts; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"globalData\", function() { return globalData; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"calculateBudget\", function() { return calculateBudget; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteCtrlItem\", function() { return deleteCtrlItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getBudgetInfo\", function() { return getBudgetInfo; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getItemPercentage\", function() { return getItemPercentage; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"newItem\", function() { return newItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"calculateItemPercentage\", function() { return calculateItemPercentage; });\n/* harmony import */ var _models_Expense_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/Expense.js */ \"./src/js/models/Expense.js\");\n/* harmony import */ var _models_Income_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/Income.js */ \"./src/js/models/Income.js\");\n\r\n\r\n\r\n//BUDGET CONTROLLER\r\n\r\nconst calculateTotalAmounts = (type) => {\r\n    let total = 0;\r\n    globalData.allData[type].forEach((cur) => {\r\n        total += cur.value;\r\n    });\r\n    globalData.totalAmount[type] = total;\r\n};\r\n\r\nconst globalData = {\r\n    allData: {\r\n        inc: [],\r\n        exp: []\r\n    },\r\n    totalAmount: {\r\n        inc: [],\r\n        exp: []\r\n    },\r\n    totalBudget: 0,\r\n    totalPercentages: 0\r\n}\r\n\r\nconst calculateBudget = () => {\r\n    calculateTotalAmounts('inc');\r\n    calculateTotalAmounts('exp');\r\n    globalData.totalBudget = globalData.totalAmount.inc - globalData.totalAmount.exp;\r\n    if (globalData.totalAmount.inc > 0) {\r\n        globalData.totalPercentages = Math.round((globalData.totalAmount.exp / globalData.totalAmount.inc) * 100);\r\n    } else {\r\n        globalData.totalPercentages = -1;\r\n    }\r\n};\r\n\r\nconst deleteCtrlItem = (itemType, itemId) => {\r\n    const ids = globalData.allData[itemType].map((cur) => {\r\n        return cur.id;\r\n    });\r\n    const indexNumber = ids.indexOf(itemId);\r\n    console.log(indexNumber);\r\n    if (indexNumber !== -1) {\r\n        globalData.allData[itemType].splice(indexNumber, 1);\r\n    };\r\n    return {\r\n        itemType: itemType,\r\n        itemId: itemId\r\n    };\r\n};\r\n\r\nconst getBudgetInfo = () => {\r\n    return {\r\n        totalBudget: globalData.totalBudget,\r\n        totalIncome: globalData.totalAmount.inc,\r\n        totalExpense: globalData.totalAmount.exp,\r\n        totalPercentages: globalData.totalPercentages,\r\n        totalData: globalData.allData\r\n    }\r\n};\r\n\r\nconst getItemPercentage = () => {\r\n    const allPercentages = globalData.allData.exp.map((cur) => {\r\n        return cur.getPercentage();\r\n    });\r\n    return allPercentages;\r\n};\r\n\r\nconst newItem = (type,description,value) => {\r\n    let newItem;\r\n    let id;\r\n    if (globalData.allData[type].length > 0) {\r\n        id = (globalData.allData[type][globalData.allData[type].length - 1].id) + 1;\r\n    } else {\r\n        id = 0;\r\n    }\r\n    if (type === 'inc') {\r\n        newItem = new _models_Income_js__WEBPACK_IMPORTED_MODULE_1__[\"Income\"](id, description, value, type);\r\n    } else if (type === 'exp') {\r\n        newItem = new _models_Expense_js__WEBPACK_IMPORTED_MODULE_0__[\"Expense\"](id, description, value, type);\r\n    }\r\n    globalData.allData[type].push(newItem);\r\n    return newItem;\r\n};\r\n\r\nconst calculateItemPercentage = () => {\r\n    globalData.allData.exp.forEach((cur) => {\r\n        cur.calculatePercentage(globalData.totalAmount.inc);\r\n    });\r\n};\r\n\n\n//# sourceURL=webpack:///./src/js/components/budgetctrl.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/js/style.css\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/budgetctrl */ \"./src/js/components/budgetctrl.js\");\n/* harmony import */ var _views_uictrl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/uictrl */ \"./src/js/views/uictrl.js\");\n\r\n\r\n\r\n\r\n\r\n//APP CONTROLLER\r\n\r\n\r\nconst dom = _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"getDomPaths\"]();\r\n\r\n\r\n//LOCAL STORAGE\r\nconst itemsStorage = localStorage.getItem('items') ? JSON.parse(localStorage.getItem('items')) : [];\r\nconst addStorageItem = (newItem) => {\r\n    itemsStorage.push(newItem);\r\n    localStorage.setItem('items', JSON.stringify(itemsStorage));\r\n};\r\n\r\nconst clearStorageData = () => {\r\n    const question = confirm(`Do You want to erase all data? Press 'OK' to confirm, press 'Cancel' to stop the action.`);\r\n    if (question == true) {\r\n        localStorage.clear();\r\n        updateBudget();\r\n        _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayBudgetInfo\"]({\r\n            totalBudget: 0,\r\n            totalIncome: 0,\r\n            totalExpense: 0,\r\n            totalPercentages: `---`\r\n        });\r\n        _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"deleteAllUiItems\"]();\r\n        location.reload();\r\n        console.log('1', _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"globalData\"]);\r\n    }\r\n};\r\n\r\nconst deleteStorageItem = (selectedItem) => {\r\n    console.log(selectedItem)\r\n    let retrieveData = JSON.parse(localStorage.getItem('items'));\r\n    console.log('rd', retrieveData);\r\n    for (let specificItem of retrieveData) {\r\n        if (specificItem.id === parseInt(selectedItem.itemId)) {\r\n            retrieveData.splice(specificItem.id, 1);\r\n            localStorage.setItem('items', JSON.stringify(retrieveData));\r\n        }\r\n    }\r\n};\r\n\r\nconst addNewItem = () => {\r\n    let input = _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"getInputs\"]();\r\n    if (input.description !== \"\" && input.value > 0 && !isNaN(input.value)) {\r\n        let obj = _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"newItem\"](input.type, input.description, input.value);\r\n        console.log('obj', obj);\r\n        _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayItem\"](obj);\r\n        _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"clearInputValues\"]();\r\n        updateBudget();\r\n        updatePercentages();\r\n        // addStorageItem(obj);\r\n    };\r\n    document.querySelector(dom.descriptionInput).focus();\r\n};\r\n\r\nconst deleteItem = (item) => {\r\n    const splitItem = item.split('-');\r\n    const itemType = splitItem[0];\r\n    const itemId = parseInt(splitItem[1]);\r\n    _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"deleteCtrlItem\"](itemType, itemId);\r\n    _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"deleteUiItem\"](item);\r\n    updateBudget();\r\n    updatePercentages();\r\n};\r\n\r\nconst updatePercentages = () => {\r\n    _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"calculateItemPercentage\"]();\r\n    const itemPercentages = _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"getItemPercentage\"]();\r\n    _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayItemPercentage\"](itemPercentages);\r\n}\r\n\r\nconst updateBudget = () => {\r\n    _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"calculateBudget\"]();\r\n    let budgetInfo = _components_budgetctrl__WEBPACK_IMPORTED_MODULE_1__[\"getBudgetInfo\"]();\r\n    console.log('budgetinfo', budgetInfo);\r\n    _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayBudgetInfo\"](budgetInfo);\r\n};\r\n\r\nconst setupEventListeners = () => {\r\n    document.querySelector(dom.addBtn).addEventListener('click', addNewItem);\r\n    document.addEventListener('keypress', (e) => {\r\n        if(e.keyCode == 13 || e.which == '13') {\r\n            addNewItem();\r\n        };\r\n    });\r\n    document.querySelector(dom.itemsContainer).addEventListener('click', (e) => {\r\n        const delItem = e.target.parentNode.parentNode.parentNode.parentNode.id;\r\n        if (delItem) {\r\n            deleteItem(delItem);\r\n        }\r\n    });\r\n    document.querySelector(dom.clearStorageBtn).addEventListener('click', clearStorageData);\r\n};\r\n    \r\n\r\nconst appInit = () => {\r\n    const localStorageTest = () => {\r\n        const test = \"test\" + new Date().valueOf();\r\n        try {\r\n            localStorage.setItem(test, test);\r\n            localStorage.removeItem(test);\r\n            return true;\r\n        } catch(e) {\r\n            return false;\r\n        }\r\n    };\r\n\r\n    if (localStorageTest()) {\r\n        if (localStorage.hasOwnProperty('items')) {\r\n            let loadData = JSON.parse(localStorage.getItem('items'));\r\n            console.log(loadData);\r\n            loadData.forEach((item) => {\r\n                _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayItem\"](item);\r\n            });\r\n        } else {\r\n            _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayBudgetInfo\"]({\r\n                totalBudget: 0,\r\n                totalIncome: 0,\r\n                totalExpense: 0,\r\n                totalPercentages: `---`\r\n            });\r\n        }\r\n    };\r\n\r\n    let input = _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"getInputs\"]();\r\n    setupEventListeners();\r\n    _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"displayMonth\"]();\r\n    _views_uictrl__WEBPACK_IMPORTED_MODULE_2__[\"changeBorderColor\"](input.type);\r\n}\r\n\r\n\r\nappInit();\r\n\r\n\r\n// to do\r\n/*\r\n    - store dates in localStorage\r\n    - localStorage ()\r\n*/\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/js/style.css?");

/***/ }),

/***/ "./src/js/views/uictrl.js":
/*!********************************!*\
  !*** ./src/js/views/uictrl.js ***!
  \********************************/
/*! exports provided: domPaths, clearInputValues, changeBorderColor, displayDateItem, displayItem, displayFormatedNumber, displayItemPercentage, displayBudgetInfo, deleteUiItem, displayMonth, deleteAllIncomeItems, deleteAllExpenseItems, deleteAllUiItems, getDomPaths, getInputs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"domPaths\", function() { return domPaths; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearInputValues\", function() { return clearInputValues; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeBorderColor\", function() { return changeBorderColor; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayDateItem\", function() { return displayDateItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayItem\", function() { return displayItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayFormatedNumber\", function() { return displayFormatedNumber; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayItemPercentage\", function() { return displayItemPercentage; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayBudgetInfo\", function() { return displayBudgetInfo; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteUiItem\", function() { return deleteUiItem; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayMonth\", function() { return displayMonth; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteAllIncomeItems\", function() { return deleteAllIncomeItems; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteAllExpenseItems\", function() { return deleteAllExpenseItems; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteAllUiItems\", function() { return deleteAllUiItems; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getDomPaths\", function() { return getDomPaths; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInputs\", function() { return getInputs; });\n//UI CONTROLLER\r\n\r\n\r\nconst domPaths = {\r\n    addBtn: '.add__btn',\r\n    clearStorageBtn: '.clear__btn',\r\n    descriptionInput: '.add__description',\r\n    valueInput: '.add__value',\r\n    typeInput: '.add__type',\r\n    incomeList: '.income__list',\r\n    expenseList: '.expenses__list',\r\n    totalBudgetDisplay: '.budget__value',\r\n    totalIncomeDisplay: '.budget__income--value',\r\n    totalExpenseDisplay: '.budget__expenses--value',\r\n    totalExpensePercentageDisplay: '.budget__expenses--percentage',\r\n    itemsContainer: '.container',\r\n    itemPercentage: '.item__percentage',\r\n    monthDesc: '.budget__title--month'\r\n};\r\n\r\nconst clearInputValues = () => {\r\n    document.querySelector(domPaths.descriptionInput).value = \"\";\r\n    document.querySelector(domPaths.valueInput).value = \"\";\r\n};\r\n\r\nconst changeBorderColor = () => {\r\n    const inputType  = document.querySelector(domPaths.typeInput);\r\n    const children = document.querySelectorAll(`[data-border='toggle']`);\r\n    const childrenArray = Array.from(children);\r\n    inputType.addEventListener('change', () => {\r\n        inputType.classList.toggle('toggle_border');\r\n        childrenArray.forEach((cur) => {\r\n            cur.classList.toggle('toggle_border_container');\r\n        })\r\n    });\r\n};\r\n\r\nconst displayDateItem = () => {\r\n    const date = new Date();\r\n    const day = date.getDate();\r\n    const month = date.getMonth() + 1;\r\n    if (month < 10) {\r\n        return `${day}.0${month}`;\r\n    } else {\r\n        return `${day}.${month}`;\r\n    }\r\n};\r\n\r\nconst displayItem = (item) => {\r\n    const incList = document.querySelector(domPaths.incomeList);\r\n    const expList = document.querySelector(domPaths.expenseList);\r\n    const incMarkup = \r\n    `<div class=\"item clearfix\" id=\"${item.type}-${item.id}\">\r\n        <div class=\"item_date\">${displayDateItem.call()}</div>\r\n        <div class=\"item__description\">${item.description}</div>\r\n        <div class=\"right clearfix\">\r\n            <div class=\"item__value\">${displayFormatedNumber.call(null, item.value, item.type)}</div>\r\n            <div class=\"item__delete\">\r\n                <button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button>\r\n            </div>\r\n        </div>\r\n    </div>`;\r\n    const expMarkup = \r\n    `<div class=\"item clearfix\" id=\"${item.type}-${item.id}\">\r\n        <div class=\"item_date\">${displayDateItem.call()}</div>\r\n        <div class=\"item__description\">${item.description}</div>\r\n        <div class=\"right clearfix\">\r\n            <div class=\"item__value\">${displayFormatedNumber.call(null, item.value, item.type)}</div>\r\n            <div class=\"item__percentage\">${item.percentage}%</div>\r\n            <div class=\"item__delete\">\r\n                <button class=\"item__delete--btn\"><i class=\"ion-ios-close-outline\"></i></button>\r\n            </div>\r\n        </div>\r\n    </div>`;\r\n    item.type === 'inc' ? incList.insertAdjacentHTML('beforeend', incMarkup) : expList.insertAdjacentHTML('beforeend', expMarkup);\r\n};\r\n\r\nconst displayFormatedNumber = (number, type) => {\r\n    const formatOptions = { style: 'currency', currency: 'USD' };\r\n    const formatedNumber = new Intl.NumberFormat('en-US', formatOptions);\r\n    return type === 'inc' ? `+${formatedNumber.format(number)}` : `-${formatedNumber.format(number)}`;\r\n};\r\n\r\nconst displayItemPercentage = (percentageArr) => {\r\n    const itemPercentageFields = document.querySelectorAll(domPaths.itemPercentage);\r\n    const nodeListToArr = Array.from(itemPercentageFields);\r\n    nodeListToArr.forEach((cur, index) => {\r\n        if (percentageArr[index] > 0) {\r\n            cur.textContent = `${percentageArr[index]}%`;\r\n        } else {\r\n            cur.textContent = `---`;\r\n        }\r\n    })\r\n};\r\n\r\nconst displayBudgetInfo = (obj) => {\r\n    let type;\r\n    obj.totalBudget > 0 ? type = 'inc' : 'exp';\r\n    document.querySelector(domPaths.totalBudgetDisplay).innerHTML = displayFormatedNumber.call(null, obj.totalBudget, type);\r\n    document.querySelector(domPaths.totalIncomeDisplay).innerHTML = displayFormatedNumber.call(null, obj.totalIncome, 'inc');\r\n    document.querySelector(domPaths.totalExpenseDisplay).innerHTML = displayFormatedNumber.call(null, obj.totalExpense, 'exp');\r\n    if (obj.totalPercentages > 0) {\r\n        document.querySelector(domPaths.totalExpensePercentageDisplay).innerHTML = `${obj.totalPercentages}%`;\r\n    } else {\r\n        document.querySelector(domPaths.totalExpensePercentageDisplay).innerHTML = `---`;\r\n    }\r\n};\r\n\r\nconst deleteUiItem = (itemId) => {\r\n        const el = document.getElementById(itemId);\r\n        el.parentNode.removeChild(el);\r\n};\r\n\r\nconst displayMonth = () => {\r\n    const months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];\r\n    const dateObj = new Date();\r\n    const date = months[dateObj.getMonth()] + ' ' + dateObj.getFullYear();\r\n    document.querySelector(domPaths.monthDesc).textContent = date;\r\n};\r\n\r\nconst deleteAllIncomeItems = () => {\r\n    const parentEl = document.querySelector(domPaths.incomeList);\r\n    while (parentEl.firstChild) {\r\n        parentEl.removeChild(parentEl.lastChild);\r\n    };\r\n};\r\n\r\nconst deleteAllExpenseItems = () => {\r\n    const parentEl = document.querySelector(domPaths.expenseList);\r\n    while (parentEl.firstChild) {\r\n        parentEl.removeChild(parentEl.lastChild);\r\n    };\r\n};\r\n\r\nconst deleteAllUiItems = () => {\r\n    uiCtrl.deleteAllIncomeItems.call();\r\n    uiCtrl.deleteAllExpenseItems.call();\r\n};\r\n\r\nconst getDomPaths = () => {\r\n    return domPaths;\r\n};\r\n\r\nconst getInputs = () => {\r\n    let typeInput = document.querySelector(domPaths.typeInput).value;\r\n    let descInput = document.querySelector(domPaths.descriptionInput).value;\r\n    let valueInput = parseFloat(document.querySelector(domPaths.valueInput).value);\r\n    return {\r\n        type: typeInput,\r\n        description: descInput,\r\n        value: valueInput\r\n    }\r\n};\r\n\n\n//# sourceURL=webpack:///./src/js/views/uictrl.js?");
